...
public class GridAdapterPMFirst extends BaseAdapter {
    private final List<Item> mItems = new ArrayList<Item>();
    private final LayoutInflater mInflater;

    public GridAdapterPMFirst(Context context) {
        mInflater = LayoutInflater.from(context);

       /* mItems.add(new Item("About LEAD",       R.drawable.about_new,"#97c024"));
        mItems.add(new Item("Projects",   R.drawable.project_new,"#f58d00"));*/
            ...
            public void onClick(View v) {
              //  Toast.makeText(v.getContext(), name.getText(), Toast.LENGTH_SHORT).show();
                ...
                if(itemName.equals("Projects")){
                    Intent itthomeToProject = new Intent(v.getContext(),PMProjectDetailActivity.class);
