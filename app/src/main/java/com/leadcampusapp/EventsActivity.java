...
public class EventsActivity extends AppCompatActivity implements ConnectivityReceiver.ConnectivityReceiverListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        shardpref_S_obj=EventsActivity.this.getSharedPreferences(PREFBook_Stud, Context.MODE_PRIVATE);
       ...
       /* img_eventsBack = (ImageButton) findViewById(R.id.img_eventsBack);*/
        ...
        view1 = inflater1.inflate(R.layout.currenteventtablayout, null);

        View view2;
        LayoutInflater inflater2 = (LayoutInflater) this.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        view2 = inflater2.inflate(R.layout.pasteventtablayout, null);
        ...
        TextView selectedText = (TextView) view.findViewById(R.id.txt_eventtabtitle);
        ...
        final EventsAdapter adapter = new EventsAdapter(getSupportFragmentManager(), tabLayout.getTabCount());
...
/*        String message;
    ...
    /*    if (id == R.id.action_editProfile) {
        ...
        if (id == R.id.action_logout) {
            ...
            //deleteCache(EventsActivity.this);
            Intent ittEventsToLogin = new Intent(EventsActivity.this ,LoginActivity.class);
        ...
        if (id == android.R.id.home) {
            ...
            /*if(str_role.equals("Student")) {
                Intent ittEventsToStudHome = new Intent(EventsActivity.this, HomeActivity.class);
                startActivity(ittEventsToStudHome);
            }else{
                Intent ittEventsToPMHome = new Intent(EventsActivity.this, PMHomeActivity.class);
            ...
            if(str_role.equals("Student")) {
                ...
                Intent ittEventsToStudHome = new Intent(EventsActivity.this, PrincipleHomeActivity.class);
                startActivity(ittEventsToStudHome);
            }
            else{
                Intent ittEventsToPMHome = new Intent(EventsActivity.this, PMHomeActivity.class);
