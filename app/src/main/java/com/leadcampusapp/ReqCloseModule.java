...
public class ReqCloseModule {
    private String Ticket_No;
    private String Request_Date;
    private String Respond_Date;
    ...
    public ReqCloseModule(String ticket_No, String request_Date, String response_Date, String lead_Id, String student_Name, String mobileNo, String requestHead_Id, String project_Id, String request_type, String request_Message, String response_Message, String request_Priority, String college_Name) {
        Ticket_No = ticket_No;
        Request_Date = request_Date;
        Respond_Date= response_Date;
        Lead_Id = lead_Id;
