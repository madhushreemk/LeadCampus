...
public class TShirtSizeAdapter extends BaseAdapter{

    public ArrayList<TShirtSizeModel> feesUnPaidList;
    Activity activity;
    EditText userInputDialogEditText;
    String str_requestId,str_reson;

    public TShirtSizeAdapter(Activity activity, ArrayList<TShirtSizeModel> feesUnPaidList) {
        super();
    ...
    @Override
    public TShirtSizeModel getItem(int position) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            holder.ll_requestedId =(LinearLayout) convertView.findViewById(R.id.ll_requestedId);
        ...
        TShirtSizeModel item = feesUnPaidList.get(position);
        ...
        holder.ll_requestedId.setVisibility(View.GONE);
  ...
  /*      Button btn_selectAll;
    ...
    public void filter(String charText,ArrayList<TShirtSizeModel> feesList,String selectedCollegeName) {
        ...
        if(charText!=null) {
            if(feesList!=null) {
                if (charText.isEmpty() || charText.length() == 0) {
                    ...
                    for (TShirtSizeModel wp : feesList) {
