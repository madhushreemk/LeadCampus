...
public class MasterRequestListModule {
    ...
    public static ArrayList<MasterRequestListModule> listview_arr=new ArrayList<MasterRequestListModule>();

    public MasterRequestListModule() {
    }

    public MasterRequestListModule(String lead_Id, String studentName, String isApply_MasterLeader, String isApply_LeadAmbassador, String student_Type) {
        Lead_Id = lead_Id;
