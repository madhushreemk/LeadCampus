...
public class AmbassadorRequestList {
    ...
    public static ArrayList<AmbassadorRequestList> listview_arr=new ArrayList<AmbassadorRequestList>();

    public AmbassadorRequestList(String lead_Id, String studentName, String isApply_MasterLeader, String isApply_LeadAmbassador, String student_Type) {
        Lead_Id = lead_Id;
