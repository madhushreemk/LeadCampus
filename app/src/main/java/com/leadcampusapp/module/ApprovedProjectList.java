...
public class ApprovedProjectList {
    ...
    public static ArrayList<ApprovedProjectList> listview_arr=new ArrayList<ApprovedProjectList>();

    public ApprovedProjectList(){

    }


    public ApprovedProjectList(String student_name, String project_tittle, String approved_amount, String disperse_amount, String balance_amount, String leadId, String PDId,String MobileNo,String Student_Image_Path,
