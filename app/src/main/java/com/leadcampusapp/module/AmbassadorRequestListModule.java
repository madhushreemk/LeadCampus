...
public class AmbassadorRequestListModule {
    ...
    public static ArrayList<AmbassadorRequestListModule> listview_arr=new ArrayList<AmbassadorRequestListModule>();

    public AmbassadorRequestListModule() {
    }

    public AmbassadorRequestListModule(String lead_Id, String studentName, String isApply_MasterLeader, String isApply_LeadAmbassador, String student_Type) {
        Lead_Id = lead_Id;
