...
public class FundMainActivity extends AppCompatActivity implements ConnectivityReceiver.ConnectivityReceiverListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        shardpref_S_obj= FundMainActivity.this.getSharedPreferences(PREFBook_Stud, Context.MODE_PRIVATE);
      ...
      /*  View view3;
        ...
        view1 = inflater1.inflate(R.layout.funding_tablelayout, null);

        View view2;
        LayoutInflater inflater2 = (LayoutInflater) this.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        view2 = inflater2.inflate(R.layout.fund_ticketstatus_tablayout, null);
       ...
       // tabLayout.addTab(tabLayout.newTab().setCustomView(view3));
        ...
        TextView selectedText = (TextView) view.findViewById(R.id.txt_fund);
        ...
        final FundAdapter adapter = new FundAdapter(getSupportFragmentManager(), tabLayout.getTabCount());
    ...
    private void showSnack(boolean isConnected) {
        ...
        if (!isConnected) {
            ...
            AlertDialog.Builder adb = new AlertDialog.Builder(FundMainActivity.this);
...
/*        String message;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if(id == R.id.action_feesCollect){
            Intent ittFeesPaidToHome = new Intent(FundMainActivity.this ,ManagerFeesCollectionActivity.class);
            startActivity(ittFeesPaidToHome);
            return true;
        }
        if (id == android.R.id.home) {
            Intent ittFeesPaidToHome = new Intent(FundMainActivity.this ,PMHomeActivity.class);
            startActivity(ittFeesPaidToHome);
            return true;
        }
        ...
        if (id == R.id.action_logout) {
            Intent ittFeesToLogin = new Intent(FundMainActivity.this ,LoginActivity.class);
