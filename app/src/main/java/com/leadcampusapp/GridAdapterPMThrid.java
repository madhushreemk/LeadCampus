...
public class GridAdapterPMThrid extends BaseAdapter {
    ...
    public GridAdapterPMThrid(LayoutInflater mInflater, String unapprovedCount, String complitedCount, String approvedCount, String requestForCompletion, String requestForModification, String rejected, String str_studentcount, String str_collegecount) {
    ...
    public GridAdapterPMThrid(Context context) {
        mInflater = LayoutInflater.from(context);

       /* mItems.add(new Item("Fees", R.drawable.fees_new, "#ffbc00"));
        mItems.add(new Item("ML & LA", R.drawable.mlal_new, "#d94343"));
        mItems.add(new Item("Reports", R.drawable.report_new, "#1e7145"));*/
        mItems.add(new Item("Stories",   R.drawable.story_wht,"#4285f4"));
        mItems.add(new Item("News Feeds", R.drawable.newsfeeds_new, "#800080"));
        mItems.add(new Item("Events", R.drawable.events_new, "#BF5FFF")); //#84795d
            ...
            public void onClick(View v) {
              //  Toast.makeText(v.getContext(), name.getText(), Toast.LENGTH_SHORT).show();
               ...
               /* if(itemName.equals("Fees")){
                    Intent itthomeToFeesPaid = new Intent(v.getContext(),FeesPaidActivity.class);
