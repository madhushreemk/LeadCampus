...
public class FeesUnpaidAdapterModified extends BaseAdapter{
    ...
    public FeesUnpaidAdapterModified(Activity activity, ArrayList<Class_UnpaidStudList> feesUnPaidList) {
        super();
    ...
    public View getView(int position, View convertView, ViewGroup parent)
    {
      ...
      /*  if(item.getPayment_Mode().toString().equals("1")){
            holder.rdb_Cash.setChecked(true);
            holder.rdb_Online.setChecked(false);
        }
        if(item.getPayment_Mode().toString().equals("2")){
            holder.rdb_Cash.setChecked(false);
            holder.rdb_Online.setChecked(true);
        }*/
       // holder.paymentMode.setText("1");

        //final boolean[] paycashonline = {true};
...
// set No values in ArrayList if RadioButton is checked
        ...
        holder.paymentMode.setText(feesUnPaidList.get(position).getPayment_Mode());
 ...
 /*       holder.simpleSwitch.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
             //   boolean checked = ((RadioButton) buttonView).isChecked();
                ...
                if (isChecked)
                {
                    Log.e("tag","sw_PaymentMode.getTextOn().toString() ada="+holder.simpleSwitch.getTextOn().toString());
                    paycashonline[0] =true;
                   holder.paymentMode.setText("1");
                    // The toggle is enabled
                } else {
                    paycashonline[0] =false;
                    holder.paymentMode.setText("2");
                    Log.e("tag","sw_PaymentMode.getTextOff().toString() ada="+holder.simpleSwitch.getTextOff().toString());
...
*/
        ...
        Log.e("tag","paymentMode ada="+holder.paymentMode.getText().toString());
      /*  if(holder.simpleSwitch.isChecked()){
          //  paymentMode="1";
            Log.e("tag","sw_PaymentMode.getTextOn().toString() ada="+holder.simpleSwitch.getTextOn().toString());
   ...
   /*     holder.mStatus.setOnClickListener(new View.OnClickListener() {
       ...
       // holder.rdb_Cash.setOnCheckedChangeListener();
       ...
       //
       /* holder.paymentMode_radiogroup.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
        ...
        /*public void onRadioButtonPaymentClicked(View view)
        {
  ...
  /*      Button btn_selectAll;
    ...
    /*public void paymentModeOnclick(View convertView)
    {
        boolean checked = ((RadioButton) view).isChecked();
                       ...
                       // if (wp.getCollege_name().toLowerCase(Locale.getDefault()).contains(charText) || wp.getLead_id().toLowerCase(Locale.getDefault()).contains(charText) || wp.getPhone_number().toLowerCase(Locale.getDefault()).contains(charText) || wp.getStudent_name().toLowerCase(Locale.getDefault()).contains(charText) || wp.getPhone_number().toLowerCase(Locale.getDefault()).contains(charText)) {
                        ...
                        /*if(selectedCollegeName == null) {
                           if  ((wp.getCollegeName()!=null && wp.getCollegeName().toLowerCase().contains(charText.toLowerCase())) || ( wp.getLead_id()!=null && wp.getLead_id().toLowerCase().contains(charText.toLowerCase())) || ( wp.getMobileNo()!=null && wp.getMobileNo().toLowerCase().contains(charText.toLowerCase())) || ( wp.getStudentName()!=null && wp.getStudentName().toLowerCase().contains(charText.toLowerCase()) ) || ( wp.getMobileNo()!=null && wp.getMobileNo().toLowerCase().contains(charText.toLowerCase()))) {
                            ...
                            if ((wp.getCollegeName()!=null && wp.getCollegeName().equals(selectedCollegeName)) && ((wp.getCollegeName()!=null && wp.getCollegeName().toLowerCase().contains(charText.toLowerCase())) || (wp.getLead_id()!=null && wp.getLead_id().toLowerCase().contains(charText.toLowerCase())) || (wp.getMobileNo()!=null && wp.getMobileNo().toLowerCase().contains(charText.toLowerCase())) || (wp.getStudentName()!=null && wp.getStudentName().toLowerCase().contains(charText.toLowerCase())) || (wp.getMobileNo()!=null && wp.getMobileNo().toLowerCase().contains(charText.toLowerCase())))) {
                                this.feesUnPaidList.add(wp);
                            }
                        }*/
