...
public class GridAdapterPMSecond extends BaseAdapter {
   ...
   /* public GridAdapterPMSecond(LayoutInflater mInflater, String unapprovedCount, String complitedCount, String approvedCount, String requestForCompletion, String requestForModification, String rejected, String str_studentcount, String str_collegecount) {
    ...
    public GridAdapterPMSecond(Context context){//, String unapprovedCount, String complitedCount, String approvedCount, String requestForCompletion, String requestForModification, String rejected, String str_studentcount, String str_collegecount) {
        mInflater = LayoutInflater.from(context);

        mItems.add(new Item("Fees", R.drawable.fees_new, "#df59a0"));
        mItems.add(new Item("Ticket", R.drawable.fees_new, "#df59a0"));
        mItems.add(new Item("T-Shirt", R.drawable.tshirt, "#0a64c5"));
        ...
        relativeLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
              //  Toast.makeText(v.getContext(), name.getText(), Toast.LENGTH_SHORT).show();
                ...
                if(itemName.equals("Ticket")){
                    Intent itthomeToFeesPaid = new Intent(v.getContext(),FundMainActivity.class);
                    itthomeToFeesPaid.putExtra("From","Manager");
                    v.getContext().startActivity(itthomeToFeesPaid);
                }
