...
public class ReqOpenFragment extends Fragment{
    ...
    ReqOpenModule reqOpenModule_item;
    ArrayList<ReqOpenModule> reqOpenModulesList;
    private ReqOpenAdapter adapter_reqopen;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        reqOpenModulesList = new ArrayList<ReqOpenModule>();

        lview = (ListView) view.findViewById(R.id.lv_openreq);

        GetReqqOpenlist getReqqOpenlist = new GetReqqOpenlist(getActivity());
        getReqqOpenlist.execute();
        return view;
    }

    public class GetReqqOpenlist extends AsyncTask<Void, Void, SoapObject> {
        ...
        protected SoapObject doInBackground(Void... params) {
            ...
            SoapObject response = getReqqOpenlist();
      ...
      /*      progressBar = (ProgressBar) view.findViewById(R.id.progressBar);
        ...
        protected void onPostExecute(SoapObject result1) {
           ...
           /* anyType{vmManagerOpenRequest=anyType{Ticket_No=13; Request_Date=26-06-2019 12:54:08 PM; Lead_Id=MH05102;
            ...
            reqOpenModulesList.clear();
            if(result1 != null) {

                SoapPrimitive S_Ticket_No,S_Request_Date, S_Lead_Id, S_Student_Name, S_MobileNo,S_RequestHead_Id,S_Project_Id,S_Request_type,S_Request_Message,S_Request_Priority,S_College_Name,S_Project_Name,S_MailId,S_Prog_MailId,S_Status;
                Object O_Ticket_No, O_Request_Date, O_Lead_Id, O_Student_Name, O_MobileNo, O_RequestHead_Id, O_Project_Id, O_Request_type, O_Request_Message, O_Request_Priority,O_College_Name,O_Project_Name,O_MailId,O_Prog_MailId,O_Status;
                String str_Ticket_No = null, str_Request_Date = null, str_Lead_Id = null, str_Student_Name = null, str_MobileNo = null, str_RequestHead_Id = null,str_Project_Id = null,str_Request_type = null,str_Request_Message = null,str_Request_Priority = null,str_College_Name = null,str_Project_Name = null,str_MailId = null,str_Prog_MailId= null,str_status = null;
                ...
                Log.d("soap O_Status list:",result.toString());
                        ...
                        if (str_status.equalsIgnoreCase("Success")) {
                            ...
                            if (!O_Student_Name.toString().equals("anyType{}") && !O_Student_Name.toString().equals(null)) {
                                ...
                                Log.d("Student_Name", S_Student_Name.toString());
                            ...
                            O_Project_Name = result.getProperty("ProjectName");
                            if (!O_Project_Name.toString().equals("anyType{}") && !O_Project_Name.toString().equals(null)) {
                                S_Project_Name = (SoapPrimitive) result.getProperty("ProjectName");
                                Log.d("O_Project_Name:", S_Project_Name.toString());
                                str_Project_Name = S_Project_Name.toString();

                            }

                            O_MailId = result.getProperty("MailId");
                            if (!O_MailId.toString().equals("anyType{}") && !O_MailId.toString().equals(null)) {
                                S_MailId = (SoapPrimitive) result.getProperty("MailId");
                                Log.d("O_MailId:", S_MailId.toString());
                                str_MailId = S_MailId.toString();

                            }

                            O_Prog_MailId = result.getProperty("Manager_MailId");
                            if (!O_Prog_MailId.toString().equals("anyType{}") && !O_Prog_MailId.toString().equals(null)) {
                                S_Prog_MailId = (SoapPrimitive) result.getProperty("Manager_MailId");
                                Log.d("O_Prog_MailId:", S_Prog_MailId.toString());
                                str_Prog_MailId = S_Prog_MailId.toString();

                            }


                            reqOpenModule_item = new ReqOpenModule(str_Ticket_No, str_Request_Date, str_Lead_Id, str_Student_Name, str_MobileNo, str_RequestHead_Id, str_Project_Id, str_Request_type, str_Request_Message, str_Request_Priority, str_College_Name,str_Project_Name,str_MailId,str_Prog_MailId);
                            reqOpenModulesList.add(reqOpenModule_item);
            ...
            adapter_reqopen = new ReqOpenAdapter(getActivity(), reqOpenModulesList);
            lview.setAdapter(adapter_reqopen);
...
//            progressDialog.dismiss();
    ...
    private SoapObject getReqqOpenlist() {
        String METHOD_NAME = "GetOpenRequest";
        String SOAP_ACTION1 = "http://mis.leadcampus.org/GetOpenRequest";
