...
public class PMNotificationHistoryActivity extends AppCompatActivity {
   ...
   /* public void AnimateBell() {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_editProfile) {
            Intent itthomeToEditProfile = new Intent(PMNotificationHistoryActivity.this ,PMEditProfileActivity.class);
        ...
        if (id == R.id.action_logout) {
            ...
            Intent itthomeToLogin = new Intent(PMNotificationHistoryActivity.this ,LoginActivity.class);
    ...
    private SoapObject getProjectDtls() {
        String METHOD_NAME = "GetTopTenManagerNotificationList";
        String SOAP_ACTION1 = "http://mis.leadcampus.org/GetTopTenManagerNotificationList";
           ...
           // request.addProperty("PDId",mapProjectIdProject.get(selectedProject));
            ...
            try
            {
                ...
                runOnUiThread(new Runnable() {
                    public void run() {
                        Toast.makeText(PMNotificationHistoryActivity.this,"Slow Internet or Internet Dropped", Toast.LENGTH_LONG).show();
                    }
                });
            }
                ...
                runOnUiThread(new Runnable() {
                    public void run() {
                        Toast.makeText(PMNotificationHistoryActivity.this,"Web Service Error", Toast.LENGTH_LONG).show();
                    }
                });
                //getActivity().finish();
            }
